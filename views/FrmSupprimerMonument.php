...
<html>
	<head>
		...
		<title>Supprimer monument</title>
		...
		<div class="w3-container ">
			...
			<div class="w3-card-4" id="zoneFormulaire">
				<div class="w3-container w3-blue">
				  <h1>Supprimer un monument</h1>
				</div>
				<br>
				<div  class="w3-container w3-text-red">
					<?php echo $message_erreur; ?>
				</div>
				<form class="w3-container" action="../controllers/monumentSupprimerAccept.php" method="POST">

					<p>
						<input class="w3-input" type="hidden" id="idIdMonument" name="idMonument" value="<?php echo $vIdMonument; ?>" disabled>
						<label for="idnomMonument">Nom :</label>
						<input class="w3-input" type="text" id="idnomMonument" name="nomMonument" value="<?php echo $vNomMonument; ?>" placeholder="Saisir nom monument" disabled>
					</p>
					<p>
						<label for="idadresseMonument">Adresse :</label>
						<input class="w3-input" type="text" id="idadresseMonument" name="adresseMonument" value="<?php echo $vAdresseMonument; ?>" placeholder="Saisir adresse monument" disabled >
					</p>
					<p>
