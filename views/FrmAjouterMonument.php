...
<html>
	<head>
		...
		<?php 
			...
			if ($message_erreur == "Erreur dans la saisie"){
				$vNomMonument = $_SESSION['NomMonument'];
				$vAdresseMonument = $_SESSION['AdresseMonument'];
				$vTypeMonument = $_SESSION['TypeMonument'];	
			} else {
				$vNomMonument = "";
				$vAdresseMonument = "";
				$vTypeMonument = "";						
		...
		<div class="w3-container ">
			...
			<div class="w3-card-4" id="zoneFormulaire">
				<div class="w3-container w3-blue">
				  <h1>Saisir un monument</h1>
				</div>
				<br>
				<div  class="w3-container w3-text-red">
					<?php echo $message_erreur; ?>
				</div>
				<form class="w3-container" action="../controllers/monumentCreerAccept.php" method="POST">
